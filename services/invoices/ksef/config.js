...
const ENVIRONMENTS = Object.freeze({
  test: Object.freeze({ id: 'test', apiBaseUrl: 'https://api-test.ksef.mf.gov.pl/v2', qrBaseUrl: 'https://qr-test.ksef.mf.gov.pl' }),
  demo: Object.freeze({ id: 'demo', apiBaseUrl: 'https://api-demo.ksef.mf.gov.pl/v2', qrBaseUrl: 'https://qr-demo.ksef.mf.gov.pl' }),
  prod: Object.freeze({ id: 'prod', apiBaseUrl: 'https://api.ksef.mf.gov.pl/v2', qrBaseUrl: 'https://qr.ksef.mf.gov.pl' }),
});
