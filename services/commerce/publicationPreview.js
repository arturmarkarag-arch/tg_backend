    ...
    for (const productId of productIds) {
      ...
      rows.push({
        ...
        listing: listing ? {
          ...
          priceSync: listing?.providerData?.allegro?.priceSync && typeof listing.providerData.allegro.priceSync === 'object' ? {
            state: text(listing.providerData.allegro.priceSync.state, 40),
            jobId: text(listing.providerData.allegro.priceSync.jobId, 100),
            commandId: text(listing.providerData.allegro.priceSync.commandId, 100),
            desiredHash: text(listing.providerData.allegro.priceSync.desiredHash, 128),
            appliedHash: text(listing.providerData.allegro.priceSync.appliedHash, 128),
            desiredPrice: listing.providerData.allegro.priceSync.desiredPrice || null,
            actualPrice: listing.providerData.allegro.priceSync.actualPrice || null,
            automationRule: listing.providerData.allegro.priceSync.automationRule || null,
            canRetry: listing.providerData.allegro.priceSync.canRetry === true,
            stillCurrent: listing.providerData.allegro.priceSync.stillCurrent === true,
            appliedAt: listing.providerData.allegro.priceSync.appliedAt || null,
            verifiedAt: listing.providerData.allegro.priceSync.verifiedAt || null,
            lastErrorCode: text(listing.providerData.allegro.priceSync.lastErrorCode, 200),
            lastError: text(listing.providerData.allegro.priceSync.lastError, 1500),
          } : null,
        } : null,
