...
const PROVIDERS = Object.freeze([
  ...
  },
  {
    ...
    api: [
      ...
      { id: 'offers.publish', label: 'Створення offer', operation: 'sale offers outbound', direction: 'write', implementation: PLANNED },
      { id: 'offers.update', label: 'Редагування offer', operation: 'sale offers outbound', direction: 'write', implementation: PLANNED },
