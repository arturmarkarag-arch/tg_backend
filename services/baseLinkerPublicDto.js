...
function compactOrderProduct(product = {}) {
  ...
  // identity/grouping for picking, product lookup for the photo, qty/name and
  // the gross unit price shown to warehouse workers.
  ...
  setIfDefined(out, 'price_brutto', product.price_brutto);
...
function compactOrder(order = {}) {
  ...
  setIfDefined(out, 'currency', order.currency);
