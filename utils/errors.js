...
const ERRORS = {
  ...
  supplement_target_not_eligible: { status: 409, message: ({ group, reason } = {}) =>
                                `Для групи «${group || 'без назви'}» дозамовлення відкрити не можна: ${reason || 'група недоступна'}` },
  ...
  conflict_target_not_empty:    { status: 409, message: 'Цільовий магазин має бути вільним (без продавців і активних замовлень) для перенесення з конфлікту' },
