...
const ERRORS = {
  ...
  allegro_token_encryption_not_configured: { status: 503, message: 'Для Allegro потрібно налаштувати ALLEGRO_TOKEN_ENCRYPTION_KEY.' },
  allegro_token_encrypt_failed: { status: 500, message: 'Не вдалося безпечно підготувати Allegro-токен до збереження.' },
  allegro_token_decrypt_failed: { status: 503, message: 'Не вдалося розшифрувати Allegro-токен. Перевірте ALLEGRO_TOKEN_ENCRYPTION_KEY.' },
