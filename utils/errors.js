...
const ERRORS = {
  ...
  receipt_item_in_use:      { status: 409, message: ({ reasons } = {}) =>
                                `Позицію вже не можна прибрати: ${reasons || 'товар використовується'}. ` +
                                'Ціну, кількість і фото правити можна — а щоб забрати товар зі складу, ' +
                                'архівуйте його на сторінці Складу.' },
