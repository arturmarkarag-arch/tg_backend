...
check('Stage 4 reconciliation remains GET-only while inbound remains disabled', !reconcileSlice.includes('offlineMode') && adapter.includes('[CAPABILITIES.RECEIVE]: false'));
