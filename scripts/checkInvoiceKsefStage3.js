...
check('Stage 3 online transport still defaults offlineMode=false and inbound remains disabled', online.includes('offlineMode = false') && adapter.includes('[CAPABILITIES.RECEIVE]: false'));
